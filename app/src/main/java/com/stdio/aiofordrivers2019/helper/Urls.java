package com.stdio.aiofordrivers2019.helper;

/**
 * Created by lordrus on 22.05.2016.
 */
public class Urls {
    ...
    public static final String UPLOAD_FOTO_URL =  "/taxi/appDriver/uploadDriverFoto.php";
    public static final String INFO_OLD_ORDERS_URL =  "/taxi/appDriver/infoOldOrders.php";
    public static final String INFO_PAYMENT_URL =  "/taxi/appDriver/infoPayments.php";
}
